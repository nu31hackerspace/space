...
Поки що цей проект — це просто ось цей [сайт](https://nu31.space/), але амбіції в нього дуже великі.
...
Ми для роботи з CSS використовуємо [tailwind 4](https://tailwindcss.com/)
...
3. Запустіть development server, буде доступний за адресою `http://localhost:3000`,
